...
public class TowerSpawn : MonoBehaviour
{
    ...
    public  bool click_towerspawn;

    public void Awake()
    {
        click_towerspawn = false;
    }
    public void ReadyToSpawnTower()
    {
        ...
        if (towerTemplate.wapons[0].cost > playerGold.CurrentGold)
        {
    ...
    public void SpawnTower(Transform tileTransform)
    {
        ...
        playerGold.CurrentGold -= towerTemplate.wapons[0].cost; // 타워 템플릿 추가시 사용 
        ...
        clone.GetComponent<TowerWeappon>().Setup(enemySpawn, playerGold, tile);
