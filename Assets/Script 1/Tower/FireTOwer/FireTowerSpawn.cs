...
public class FireTowerSpawn : MonoBehaviour
{
    [SerializeField]
    ...
    public bool click_firetowerspawn;

    public void Awake()
    {
        click_firetowerspawn = false;
    }
    public void ReadyToSpawnTower()
    {
        ...
        if (towerTemplate.wapons[0].cost_fire > playerGold.CurrentGold)
        {
    ...
    public void SpawnTower(Transform tileTransform)
    {
        ...
        playerGold.CurrentGold -= towerTemplate.wapons[0].cost_fire; // 타워 템플릿 추가시 사용 
        ...
        clone.GetComponent<FireTowerWeapon>().Setup(enemySpawn, playerGold, tile);
